      ...
      <div className="px-8 max-w-container mx-auto border-b border-sapi-bronze">
        <div className="flex gap-8">
          <button
            ...
            className={`font-sans text-[13px] tracking-extra-wide uppercase py-4 border-b-2 transition-colors duration-150 ${
              activeTab === 'landing'
                ...
                <tbody>
                  ...
                  <tr>
                    {TIERS.map((t) => (
                      <td
                        key={t.tier}
                        className={`p-3 font-sans text-[15px] text-sapi-muted align-top leading-relaxed ${
                          t.highlight
                            ? 'border-b border-[rgba(201,150,58,0.3)] border-l-2 border-r-2 border-sapi-gold bg-[rgba(201,150,58,0.04)]'
                            : 'border-b border-sapi-bronze'
                        }`}
                      >
                        <span className="block font-sans text-[13px] tracking-extra-wide text-sapi-gold uppercase mb-1.5">
                          Description
                        </span>
                        {t.description}
                      </td>
